...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', default='input_images/raw', help='Directory with raw images for face alignment')
    parser.add_argument('--aligned_dir', default='input_images/aligned', help='Directory for storing aligned images')
